...
((Drupal) => {
  const { isDesktopNav } = Drupal.pubsub;
  ...
  Drupal.pubsub.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.pubsub.isDesktopNav()) return;
  ...
  Drupal.pubsub.areAnySubNavsOpen = areAnySubNavsOpen;
